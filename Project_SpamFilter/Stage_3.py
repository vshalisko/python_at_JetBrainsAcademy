...
def main():
    ...
    ## alternative to train_test_split or sample: manual data split
    ...
    for feature in features[2:]:
        #N_feature_spam = train_set.loc[train_set['Target'] == "spam", feature].astype(bool).sum(axis=0)
        N_feature_spam = train_set.loc[train_set['Target'] == "spam", feature].sum(axis=0)
        #N_feature_ham = train_set.loc[train_set['Target'] == "ham", feature].astype(bool).sum(axis=0)
        N_feature_ham = train_set.loc[train_set['Target'] == "ham", feature].sum(axis=0)
