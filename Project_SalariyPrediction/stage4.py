...
## If you have a linear regression with many variables, some of them may be correlated. 
## This way, the performance of the model may decrease. A crucial step is to check 
## the model for multicollinearity and exclude the variables with a strong correlation 
## with other variables. Carry out this check, find the best model by removing the 
## variables with high correlation, and return its MAPE score.
...
print(round(min([result1_mape,result2_mape,result3_mape,
                 result4_mape,result5_mape,result6_mape]),5))
