...
combined.plot(y='age', kind='hist', bins=[0,15,35,55,70,80])
plt.show()
print('The answer to the 1st question: 15-35')

general_diagnosis = combined.diagnosis.value_counts()
#print(general_diagnosis)
general_diagnosis.plot.pie(y='diagnosis', figsize=(5, 5))
plt.show()
print('The answer to the 2nd question: pregnancy')

#print(combined["height"])
fig, axes = plt.subplots()
axes.violinplot(dataset = [combined[combined.hospital == "general"]["height"].values,
                           combined[combined.hospital == "sports"]["height"].values,
                           combined[combined.hospital == "prenatal"]["height"].values]
                )
plt.show()
print("The answer to the 3rd question: It's because sports hospital mostly treats adults, while other two mostly deal with infants.")
